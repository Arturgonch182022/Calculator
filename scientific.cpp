...
std::map<std::string, double (*)(double)> operationsunn{{"RoundDown", RoundDown},
                                                       {"RoundUp",   RoundUp},
                                                       {"Round",     Round},
                                                       {"sin",       mysin},
                                                       {"myabs",     myabs},
...
/*double myarcctg(double value) {
    if (value < 0) {
        return 3.14 / 2 + myarctg(value); //ïðîàåðèòü
    }
...
void scientific() {
    ...
    std::string s;
    std::cin >> s;
    if (operationsunn.count(s)) {
        std::cout << "enter number\n";
        double valuee;
        std::cin >> valuee;
        std::cout << operationsunn[s](valuee)<<"\n";
        return;
    }
